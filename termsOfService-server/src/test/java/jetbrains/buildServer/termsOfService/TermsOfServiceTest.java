...
public class TermsOfServiceTest extends BaseTestCase {
    ...
    public void should_support_guest_user_notice() throws Exception {
        ...
        writeConfig("<terms-of-service>\n" +
                ...
                "            <param name=\"note\" value=\"To be consistent with data protection laws, we are asking JetBrains users to review and agree to certain key points\"/>\n" +
        ...
        then(guestNotice.getNote()).isEqualTo("To be consistent with data protection laws, we are asking JetBrains users to review and agree to certain key points");
