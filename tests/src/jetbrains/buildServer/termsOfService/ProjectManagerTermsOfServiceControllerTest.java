...
public class ProjectManagerTermsOfServiceControllerTest extends BaseControllerTestCase {
    ...
    protected BaseController createController() {
        myConfig = new PropertyBasedConfig("property1", "Project Manager Terms of Service", "/pmTermsOfService.html", "_pm_text.jspf");
        PropertyBasedManager manager = new PropertyBasedManager(myConfig, TermsOfServiceUtil.PROJECT_MANAGER);
    ...
    public void test_terms_of_service_for_user() throws Exception {
        ...
        makeLoggedIn(user1);
        Assert.assertFalse(TermsOfServiceUtil.hasProjectAdminPermission(user1));
        ModelAndView modelAndView = doGet();
        Assert.assertNull(modelAndView);
    }
    ...
    public void test_terms_of_service_for_pm() throws Exception {
        ...
        makeLoggedIn(user1);
        Assert.assertTrue(TermsOfServiceUtil.hasProjectAdminPermission(user1));
        ModelAndView modelAndView = doGet();
